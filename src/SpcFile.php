...
final class SpcFile
{
	 ...
	 * @throws Nette\IOException
	 */
	public static function write(string $file, string $content, ?string $mode = ''): void
	{
		static::createDir(dirname($file));
		if (@file_put_contents($file, $content, $mode==='append'?FILE_APPEND | LOCK_EX:'') === false) { // @ is escalated to exception
